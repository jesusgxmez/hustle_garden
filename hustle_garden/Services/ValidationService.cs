...
public class ValidationService : IValidationService
{
    ...
    private const double MIN_WATER_LITERS = 0.1; // MÌnimo 0.1 litros (100ml)
    private const double MIN_HARVEST_KG = 0.01; // MÌnimo 0.01 kg (10 gramos)
    ...
    public ValidationResult ValidateImagePath(string path)
    {
        ...
        {
            return ValidationResult.Success(); // Las im·genes son opcionales
        }
        ...
        // Validar tamaÒo del archivo (m·ximo 10MB)
